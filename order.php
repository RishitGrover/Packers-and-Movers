...
<div class="container-fluid bg ">
    <div class="row">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="o_date" placeholder="Enter Order Date">
          </div>
           <div class="form-group">
            <label for="ddate">Delivary Date</label>
            <input type="text" class="form-control" name="d_date" placeholder="Enter Delivary Date">
          </div>
           <div class="form-group">
            <label for="oloc">Order Location</label>
            <input type="text" class="form-control" name="o_loc" placeholder="Enter Pick-Up Location">
          </div>
           <div class="form-group">
            <label for="dloc">Delivary Location</label>
            <input type="text" class="form-control" name="d_loc" placeholder="Enter Delivary Location">
          </div>
           <div class="form-group">
            <label for="qty">Order Quantity</label>
            <input type="text" class="form-control" name="qty" placeholder="Enter Order Quantity">
          </div>
...
if(!empty($qty) || !empty($o_date) || !empty($d_date) || !empty($o_loc) || !empty($d_loc) ){
  $host = "localhost";
  $dbUsername = "root";
  $dbPassword = "";
  $dbname = "pam";
  ...
  if(mysqli_connect_error()) {
    ...
    $INSERT = "INSERT Into orderr(qty,o_date,d_date,o_loc,d_loc) values (?,?,?,?,?)";
    
    $stmt1 = $conn1->prepare($INSERT);
    $stmt1->bind_param("issss", $qty, $o_date, $d_date, $o_loc, $d_loc);
    $stmt1->execute();
